...
const ShooterGame: React.FC = () => {
  ...
  const gameLoop = useCallback(
    (timestamp: number) => {
      ...
      const ctx = canvasRef.current ? initializeGame(canvasRef as React.RefObject<HTMLCanvasElement>) : null;
      if (!ctx) return;
  ...
  return (
    <div className="zitibit-shootergame">
      <div className="zitibit-shootergame__name">
        <Ratings />
      </div>
      <div className="zitibit-shootergame__gamecontainer">
        <GameHeader
      ...
      <div className="zitibit-shootergame__intro">
        <ShooterGameIntro />
      </div>
    </div>
  );
